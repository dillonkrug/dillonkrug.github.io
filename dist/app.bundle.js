...
var Route = exports.Route = (0, _create2.default)(null);

var PARAM_START_RE = /^:/;
var PARAM_VALUE_RE_STR = '([^/]*)';
function isParam(part) {
	return PARAM_START_RE.test(part);
}

function getParams(route, hash) {
...
function addRoute(route) {
	...
	var regexParts = [],
	    params = [null];
	route.path.split('/').forEach(function (part) {
		if (isParam(part)) {
...
var _inferno = __webpack_require__(30);
...
/* global document */
_inferno2.default.render((0, _inferno.h)(_app.AppView), document.getElementById('app'));
...
var _day = __webpack_require__(90);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var DayView = exports.DayView = function (_Component) {
	(0, _inherits3.default)(DayView, _Component);

	function DayView(props, context) {
		(0, _classCallCheck3.default)(this, DayView);

		var _this = (0, _possibleConstructorReturn3.default)(this, (DayView.__proto__ || (0, _getPrototypeOf2.default)(DayView)).call(this, props, context));
	...
	(0, _createClass3.default)(DayView, [{
		key: 'load',
		value: function load(date) {
			var _this2 = this;

			this.dataPath = '/data/' + date.y + '/' + date.m + '/' + date.d;
			return _day.DayApi.getData(date).then(function (data) {
...
var DayApi = exports.DayApi = function () {
	function DayApi() {
		(0, _classCallCheck3.default)(this, DayApi);
	}

	(0, _createClass3.default)(DayApi, null, [{
		key: 'getData',
		value: function getData(_ref) {
			...
			return _bluebird2.default.cast(fetch('/data/' + y + '/' + m + '/' + d + '/date.json')).call('json').catch(function (err) {
				return {
					title: 'No Data',
					img: []
				};
...
function getDateUrl(date) {
	return ['#', 'day', date.getUTCFullYear(), pad(date.getUTCMonth() + 1), pad(date.getUTCDate())].join('/');
}
...
var AppView = exports.AppView = function (_Component) {
	...
	function AppView(props) {
		...
		var _this = (0, _possibleConstructorReturn3.default)(this, (AppView.__proto__ || (0, _getPrototypeOf2.default)(AppView)).call(this, props));

		var date = new Date(Date.UTC(2017, 8, 21));
		_this.state = _this.getProps(window.location.hash || getDateUrl(date));
		return _this;
	}

	(0, _createClass3.default)(AppView, [{
		key: 'getProps',
		value: function getProps(path) {
			return {
				path: path,
				params: (0, _route.getParams)((0, _route.getRoute)(path), path)
			};
		}
	}, {
		...
		value: function componentWillMount() {
			...
			window.onhashchange = function () {
				...
				_this2.setState(_this2.getProps(window.location.hash));
			};
		}
	}, {
		key: 'render',
		value: function render(x, _ref2) {
			var path = _ref2.path,
			    params = _ref2.params;
